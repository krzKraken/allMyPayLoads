...
# Funcion Filter
# Funcion que recibe como parametro una funcion y un iterable
print(f"[yellow]{separador} funcion filter {separador}[/yellow]")
filtro_pares = list(filter(lambda x: x%2==0, numeros))
print(filtro_pares)

# Funcion reduce
# from functools import reduce, itera por una lista tomando dos elementos y aumentando posicion en 1 
print(f"[yellow]{separador} funcion reduce {separador}[/yellow]")
